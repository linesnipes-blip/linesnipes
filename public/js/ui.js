      ...
      h('div', { cls: 'card fade-up' },
        ...
        h('div', { style: { display: 'grid', gridTemplateColumns: isP ? '1fr 1fr 1fr' : '1fr 1fr', gap: '10px', marginBottom: '14px' } },
          h('div', {}, h('div', { cls: 'lbl' }, S.bonusType === 'risk_free' ? 'Bet Amount ($)' : 'Boost %'),
            h('input', { type: 'number', value: S.boostPct, placeholder: '50', onInput: (e) => set({ boostPct: e.target.value }) })),
          h('div', {}, h('div', { cls: 'lbl' }, 'Max Bet ($)'),
            h('input', { type: 'number', value: S.maxBet, placeholder: '50', onInput: (e) => set({ maxBet: e.target.value }) })),
          isP ? h('div', {}, h('div', { cls: 'lbl' }, 'Min Legs'),
            h('input', { type: 'number', value: S.numLegs, placeholder: '3', min: '2', max: '10', onInput: (e) => set({ numLegs: e.target.value }) })) : null),
        h('div', { style: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', marginBottom: '14px' } },
          h('div', {}, h('div', { cls: 'lbl' }, 'Min Odds'), h('input', { type: 'text', value: S.minOdds, placeholder: 'e.g. -200', onInput: (e) => set({ minOdds: e.target.value }) })),
          h('div', {}, h('div', { cls: 'lbl' }, 'Max Odds'), h('input', { type: 'text', value: S.maxOdds, placeholder: 'e.g. +500', onInput: (e) => set({ maxOdds: e.target.value }) }))),
