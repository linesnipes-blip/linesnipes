...
// ═══════════════════════════════════════════════════
const LOGO='data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" width="160" height="36" viewBox="0 0 160 36"><circle cx="18" cy="18" r="16" fill="none" stroke="%23e53e3e" stroke-width="2.5"/><circle cx="18" cy="18" r="11" fill="none" stroke="%23e53e3e" stroke-width="2"/><circle cx="18" cy="18" r="6" fill="none" stroke="%23e53e3e" stroke-width="2"/><circle cx="18" cy="18" r="2.5" fill="%23e53e3e"/><text x="38" y="24" font-family="Arial,sans-serif" font-weight="700" font-size="18" fill="white" letter-spacing="0.5">LineSnipes</text></svg>';
...
function pgLanding() {
  return h('div', {},
    ...
    h('section', { cls: 'hero container' },
      ...
      h('div', { cls: 'fade-up d4', style: { display: 'inline-flex', alignItems: 'center', gap: '8px', marginTop: '20px', padding: '8px 16px', borderRadius: '20px', background: 'rgba(255,255,255,.05)', border: '1px solid rgba(255,255,255,.1)', fontSize: '12px', color: 'var(--fg2)' } },
...
function parlayResults() {
  ...
  return h('div', { cls: 'card', style: { borderColor: 'rgba(155,201,242,.12)', background: 'linear-gradient(180deg,rgba(155,201,242,.025) 0%,transparent 100%)', animation: 'fadeUp .4s ease' } },
    h('div', { style: { display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' } },
      ...
      h('div', { style: { fontFamily: 'var(--display)', fontSize: '16px', fontWeight: '800', color: '#fff' } }, 'Best ' + S.numLegs + (S.maxNumLegs && S.maxNumLegs !== S.numLegs ? '–' + S.maxNumLegs : '') + '-Leg ' + ml)),
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          a: 'Yes! LineSnipes is a Progressive Web App (PWA) — install it to your home screen without the App Store or Google Play. On iPhone: open in Safari, tap the Share button, then "Add to Home Screen." On Android: open in Chrome, tap the three-dot menu, then "Add to Home Screen" or "Install App." Once installed it opens full screen like a native app, loads faster, and works with your existing account.'
        },
      ]
    },
    {
